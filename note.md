...
- [VueRouter_基础](#vuerouter_基础)
  ...
  - [history 模式](#history-模式)
    - [ps](#ps)
- [VueRouter_命名路由-嵌套路由-重定向-别名](#vuerouter_命名路由-嵌套路由-重定向-别名)
  - [命名路由](#命名路由)
  - [嵌套路由](#嵌套路由)
  - [重定向](#重定向)
  - [别名](#别名)
- [VueRouter_编程式的导航](#vuerouter_编程式的导航)
  - [$router](#router)
  ...
  - [$route](#route)
    ...
    - [$route.redirectedFrom](#routeredirectedfrom)
- [VueRouter_动态路由匹配](#vuerouter_动态路由匹配)
- [VueRouter_命名视图-路由组件传参](#vuerouter_命名视图-路由组件传参)
  - [命名视图](#命名视图)
  - [路由组件传参](#路由组件传参)
    - [布尔模式](#布尔模式)
    - [对象模式](#对象模式)
    - [函数模式](#函数模式)
- [VueRouter_导航守卫](#vuerouter_导航守卫)
  - [全局守卫](#全局守卫)
  ...
  - [完整的导航解析流程](#完整的导航解析流程)
- [VueRouter_路由元信息](#vuerouter_路由元信息)
- [VueRouter_过渡动效-滚动行为](#vuerouter_过渡动效-滚动行为)
  - [过渡动效](#过渡动效)
  - [滚动行为](#滚动行为)
    - [mapState 辅助函数](#mapstate-辅助函数)
- [Vuex_Getter](#vuex_getter)
  - [通过属性访问](#通过属性访问)
  - [通过方法访问](#通过方法访问)
  - [mapGetters 辅助函数](#mapgetters-辅助函数)
- [Vuex_Mutation](#vuex_mutation)
...
参数：
  - {string}  组件名用字符串
  - {Function | Object} [definition] 函数或者对象
用法：
...
注意：transition内是不能写多个元素过渡的，多元素过渡的意思是在多个元素中选择一个去切换展示
...
### ps
路由组件全部放在views中，引入路由都放在router.js中，初始化样式引入reset.js
